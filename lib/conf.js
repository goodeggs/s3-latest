...
var argv, conf, confSchema, convict, e, helpAndQuit, key, optimist, val, versionAndQuit;
...
helpAndQuit = function() {
  ...
  help = [pkgInfo.description, "--version Print out current version and exit"];
...
for (key in confSchema) {
  val = confSchema[key];
  if (!((val["default"] != null) || (conf.get(key) != null))) {
    helpAndQuit();
  }
}
